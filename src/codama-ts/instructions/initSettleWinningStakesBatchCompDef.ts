...
export const INIT_SETTLE_WINNING_STAKES_BATCH_COMP_DEF_DISCRIMINATOR: ReadonlyUint8Array =
...
export type InitSettleWinningStakesBatchCompDefInstruction<
...
export type InitSettleWinningStakesBatchCompDefInstructionData = {
  discriminator: ReadonlyUint8Array;
  args: InitCompDefArgs;
};

export type InitSettleWinningStakesBatchCompDefInstructionDataArgs = {
  args: InitCompDefArgsArgs;
};

export function getInitSettleWinningStakesBatchCompDefInstructionDataEncoder(): Encoder<InitSettleWinningStakesBatchCompDefInstructionDataArgs> {
...
export function getInitSettleWinningStakesBatchCompDefInstructionDataDecoder(): Decoder<InitSettleWinningStakesBatchCompDefInstructionData> {
...
export function getInitSettleWinningStakesBatchCompDefInstructionDataCodec(): Codec<
  InitSettleWinningStakesBatchCompDefInstructionDataArgs,
  InitSettleWinningStakesBatchCompDefInstructionData
> {
  return combineCodec(
...
export type InitSettleWinningStakesBatchCompDefAsyncInput<
...
> = {
  ...
  args: InitSettleWinningStakesBatchCompDefInstructionDataArgs["args"];
};

export async function getInitSettleWinningStakesBatchCompDefInstructionAsync<
  TAccountPayer extends string,
  TAccountConfig extends string,
  TAccountMxeAccount extends string,
  TAccountCompDefAccount extends string,
...
export function getInitSettleWinningStakesBatchCompDefInstruction<
  TAccountPayer extends string,
  TAccountConfig extends string,
  TAccountMxeAccount extends string,
  TAccountCompDefAccount extends string,
...
> = {
  ...
  data: InitSettleWinningStakesBatchCompDefInstructionData;
};
