...
export const INIT_REVEAL_ROUND_RAND_COMP_DEF_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([237, 164, 229, 147, 106, 136, 149, 90]);

export function getInitRevealRoundRandCompDefDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    INIT_REVEAL_ROUND_RAND_COMP_DEF_DISCRIMINATOR
  );
}

export type InitRevealRoundRandCompDefInstruction<
...
export type InitRevealRoundRandCompDefInstructionData = {
  discriminator: ReadonlyUint8Array;
  args: InitCompDefArgs;
};

export type InitRevealRoundRandCompDefInstructionDataArgs = {
  args: InitCompDefArgsArgs;
};

export function getInitRevealRoundRandCompDefInstructionDataEncoder(): Encoder<InitRevealRoundRandCompDefInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: INIT_REVEAL_ROUND_RAND_COMP_DEF_DISCRIMINATOR,
    })
  );
}

export function getInitRevealRoundRandCompDefInstructionDataDecoder(): Decoder<InitRevealRoundRandCompDefInstructionData> {
...
export function getInitRevealRoundRandCompDefInstructionDataCodec(): Codec<
  InitRevealRoundRandCompDefInstructionDataArgs,
  InitRevealRoundRandCompDefInstructionData
> {
  return combineCodec(
    getInitRevealRoundRandCompDefInstructionDataEncoder(),
    getInitRevealRoundRandCompDefInstructionDataDecoder()
  );
}

export type InitRevealRoundRandCompDefAsyncInput<
...
> = {
  ...
  args: InitRevealRoundRandCompDefInstructionDataArgs["args"];
};

export async function getInitRevealRoundRandCompDefInstructionAsync<
  TAccountPayer extends string,
  TAccountConfig extends string,
  TAccountMxeAccount extends string,
  TAccountCompDefAccount extends string,
...
>(
  input: InitRevealRoundRandCompDefAsyncInput<
    TAccountPayer,
    TAccountConfig,
    TAccountMxeAccount,
    TAccountCompDefAccount,
  ...
  InitRevealRoundRandCompDefInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountConfig,
    TAccountMxeAccount,
...
> {
  ...
  return Object.freeze({
    ...
    data: getInitRevealRoundRandCompDefInstructionDataEncoder().encode(
      args as InitRevealRoundRandCompDefInstructionDataArgs
    ),
    programAddress,
  } as InitRevealRoundRandCompDefInstruction<TProgramAddress, TAccountPayer, TAccountConfig, TAccountMxeAccount, TAccountCompDefAccount, TAccountAddressLookupTable, TAccountLutProgram, TAccountArciumProgram, TAccountSystemProgram>);
}

export type InitRevealRoundRandCompDefInput<
  TAccountPayer extends string = string,
  TAccountConfig extends string = string,
  TAccountMxeAccount extends string = string,
  TAccountCompDefAccount extends string = string,
...
export function getInitRevealRoundRandCompDefInstruction<
  TAccountPayer extends string,
  TAccountConfig extends string,
  TAccountMxeAccount extends string,
  TAccountCompDefAccount extends string,
  ...
  TProgramAddress extends Address = typeof ZINC_PROGRAM_ADDRESS
>(
  input: InitRevealRoundRandCompDefInput<
    TAccountPayer,
    TAccountConfig,
    TAccountMxeAccount,
    TAccountCompDefAccount,
...
export type ParsedInitRevealRoundRandCompDefInstruction<
  TProgram extends string = typeof ZINC_PROGRAM_ADDRESS,
...
> = {
  ...
  data: InitRevealRoundRandCompDefInstructionData;
};

export function parseInitRevealRoundRandCompDefInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedInitRevealRoundRandCompDefInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getInitRevealRoundRandCompDefInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
