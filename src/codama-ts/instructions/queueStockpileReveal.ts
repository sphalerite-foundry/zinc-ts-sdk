...
export const QUEUE_STOCKPILE_REVEAL_DISCRIMINATOR: ReadonlyUint8Array =
...
export type QueueStockpileRevealInstruction<
...
export type QueueStockpileRevealInstructionData = {
  discriminator: ReadonlyUint8Array;
  computationOffset: bigint;
};

export type QueueStockpileRevealInstructionDataArgs = {
  computationOffset: number | bigint;
};

export function getQueueStockpileRevealInstructionDataEncoder(): FixedSizeEncoder<QueueStockpileRevealInstructionDataArgs> {
...
export function getQueueStockpileRevealInstructionDataDecoder(): FixedSizeDecoder<QueueStockpileRevealInstructionData> {
...
export function getQueueStockpileRevealInstructionDataCodec(): FixedSizeCodec<
  QueueStockpileRevealInstructionDataArgs,
  QueueStockpileRevealInstructionData
> {
  return combineCodec(
...
export type QueueStockpileRevealAsyncInput<
...
> = {
  ...
  computationOffset: QueueStockpileRevealInstructionDataArgs["computationOffset"];
};

export async function getQueueStockpileRevealInstructionAsync<
  TAccountSigner extends string,
  TAccountConfig extends string,
  TAccountBoard extends string,
  TAccountStockpile extends string,
...
export function getQueueStockpileRevealInstruction<
  TAccountSigner extends string,
  TAccountConfig extends string,
  TAccountBoard extends string,
  TAccountStockpile extends string,
