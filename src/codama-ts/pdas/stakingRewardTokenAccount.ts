...
export async function findStakingRewardTokenAccountPda(
  ...
  return await getProgramDerivedAddress({
    ...
    seeds: [
      ...
      getBytesEncoder().encode(
        new Uint8Array([
          115, 116, 97, 107, 105, 110, 103, 45, 114, 101, 119, 97, 114, 100, 45,
          116, 111, 107, 101, 110, 45, 97, 99, 99, 111, 117, 110, 116,
        ]),
      ),
    ],
  });
